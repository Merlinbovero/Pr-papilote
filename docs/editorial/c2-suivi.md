...
1. **C2-A** — ouvrir réellement les sources, mettre à jour le registre. Aucun
   tracé avant que ce commit ne soit poussé.
2. **C2-B** — jetons graphiques dans les deux thèmes.
3. **C2-C** — gardes automatisées + fixtures négatives.
4. **C2-D** — P-4.
5. **C2-E** — P-6.
