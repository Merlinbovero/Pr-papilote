...
/**
 * Les quinze pages dont les identifiants SVG ont été rendus uniques — lot M10.
 *
 ...
 * disparu. La seizième page — `chaine-pitot-statique` — est exclue et reste
 * dans la dette : ses deux définitions diffèrent, les unifier changerait le
 * rendu.
 */
const CORRIGEES = [
