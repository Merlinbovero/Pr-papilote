            ...
            <li>
              ...
              >
                <Card className="border-primary/30 hover:border-primary h-full transition-colors">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-base">
                      <TriangleIcon aria-hidden className="text-primary size-4" />
                      Test des triangles
                    </CardTitle>
                    <CardDescription>
                      Deux triangles blancs à combler — trouver la règle de la figure, c’est trouver
                      la pièce.
                    </CardDescription>
                  </CardHeader>
                </Card>
            ...
            <li>
              ...
              >
                <Card className="border-primary/30 hover:border-primary h-full transition-colors">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-base">
                      <RepeatIcon aria-hidden className="text-primary size-4" />
                      Révision espacée
                    </CardTitle>
                    <CardDescription>
