...
export default function sitemap(): MetadataRoute.Sitemap {
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: absoluteUrl("/bia"), changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/bia/examen-blanc"), changeFrequency: "monthly", priority: 0.7 },
    {
      url: absoluteUrl("/psychotechnique/entrainement"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: absoluteUrl("/psychotechnique/secpil"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: absoluteUrl("/psychotechnique/orientation"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
    ...
    {
      url: absoluteUrl("/psychotechnique/formes-imbriquees"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: absoluteUrl("/psychotechnique/dominos"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: absoluteUrl("/psychotechnique/appareils-photos"),
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
  ...
  for (const matiere of [...bia.matieres, bia.epreuveFacultative]) {
    entries.push({
      url: absoluteUrl(`/bia/${matiere.slug}`),
      changeFrequency: "monthly",
      priority: 0.6,
    });
  }
