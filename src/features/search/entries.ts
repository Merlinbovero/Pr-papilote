...
const OUTILS: SearchEntryInput[] = [
  ...
  {
    id: "outil.calcul-mental",
    type: "outil",
    family: "simulateur",
    title: "Calcul mental",
    summary:
      "Neuf thèmes (opérations, grilles 3×3, ordres de grandeur, fractions et pourcentages, calculs du métier), trois niveaux, format officiel 24 questions en 8 minutes ou séries sans fin.",
    moduleName: "Psychotechnique",
    moduleSlug: "psychotechnique",
    url: "/psychotechnique/calcul-mental",
    aliases: [
      "calcul mental",
      "calcul",
      "opérations",
  ...
  },
  {
    ...
    summary:
      "Lire une attitude de vol (horizon et compas) et retrouver l'aéronef correspondant, rendu en 3D — questions générées à l'infini.",
    moduleName: "Psychotechnique",
    moduleSlug: "psychotechnique",
    url: "/psychotechnique/orientation",
    aliases: [
      "orientation",
