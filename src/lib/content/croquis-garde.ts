 ...
 *
 * **Vide à l'introduction de la garde**, et ce n'est pas un oubli : la garde
 * est livrée et prouvée avant que le premier croquis ne l'honore. L'ordre
 * inverse — dessiner puis écrire la règle qui accepte le dessin — produit une
 * règle taillée sur son unique exemple.
 */
